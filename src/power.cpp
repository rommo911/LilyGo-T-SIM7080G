...
namespace power
{
    ...
    void loopPower(void *arg)
    {
        ...
        Serial.println("entering power loop");
        while (1)
        {
            delay(5000);
            if (pmu_flag)
            {
                ...
                if (PMU.isBatRemoveIrq())
                {
                    ...
                    mqttLogger.println("battery removed ! ");
                }
                ...
                if (PMU.isBatChagerDoneIrq())
                {
                    ...
                    mqttLogger.println("battery done charging ! ");
                }
                if (PMU.isBatChagerStartIrq())
                {
                    Serial.println("isBatChagerStartIrq");
                    mqttLogger.println("battery started charging ... ");
                }
                ...
                if (PMU.isDropWarningLevel2Irq())
                {
                    ...
                    {
                        mqttLogger.println("battery low ... ");
                ...
                if (PMU.isDropWarningLevel1Irq())
                {
                    ...
                    while (i--)
                    {
                        mqttLogger.println("battery very low shutting ... ");
            ...
            if (millis() - loopMillis > 60000)
            {
                ...
                loopMillis = millis();
                mqttLogger.printfTopic("battpct", "%d\n", PMU.getBatteryPercent());
                mqttLogger.printfTopic("battvol", "%d\n", PMU.getBattVoltage());
            }
        }
    }
